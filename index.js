...
//nestedFunction can access the variable internal because it is outside of its internal scope and can pull things from the outside only.
...
function USApop(arr) {
  return arr.reduce((a, animals) => {
    return a + animals.population;
  }, 0);
}
...
CuboidMaker.prototype.surfaceArea = function () {
  return (
    2 * (this.width + this.length * this.height + this.width * this.height)
  );
};
